      ...
      <div className="tp-offcanvas-area">
        <div className={`tpoffcanvas ${isOpen ? 'opened' : ''}`}>
          <div className="tpoffcanvas__logo">
            <Link href="/">
            <a href="#" style={{fontSize: 42, fontWeight: 'bold', color: 'white'}}>Digital Agency</a>
            </Link>
          </div>
          ...
          <div className="tpoffcanvas__contact">
            ...
            <ul>
              <li>
                <i className="fas fa-star"></i> <a>Poland</a>
              </li>
              <li><i className="fas fa-star"></i><a>+1 234 567</a></li>
              <li><i className="fas fa-star"></i><a>andzukor@gmail.com</a></li>
            </ul>
          </div>
